...
namespace Queue.DataAccess.Migrations
{
    ...
    [Migration("20240530051044_Iniitial")]
            ...
            modelBuilder.Entity("Queue.Models.Table", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            TableId = 18,
                            StageId = 3,
                            Username = "Room - HUMILITY"
                        },
                        new
                        {
                            TableId = 19,
                            StageId = 3,
                            Username = "Room - OPENNESS"
                        },
                        new
                        {
                            TableId = 20,
                            StageId = 3,
                            Username = "Room - OWNER'S MINDSET"
                        },
                        new
                        {
                            TableId = 21,
                            StageId = 3,
                            Username = "Room - TRANSPARENCY"
                        },
                        new
                        {
                            TableId = 22,
                            StageId = 3,
                            Username = "Room - UNITY AND LUCIA"
                        });
                });
